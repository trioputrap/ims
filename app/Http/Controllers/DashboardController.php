...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $total_bayar = Pembayaran::where('bulan', date('m'))->where('flag', 'completed')->sum("jumlah_tagihan");
        $total_pelanggan = Pelanggan::count();
        $total_bot = Pelanggan::where('chat_id',"!=","")->count();

        $pembayarans = Pembayaran::where('bulan', date('m'))->orWhere('flag', 'processed')->orWhere('flag', 'just_arrived')->get();
        $page = "Pembayaran";
